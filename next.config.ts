...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: "/assistant-travaux", destination: "/formation", permanent: true },
      {
        source: "/externalisation-administrative-btp",
        destination: "/formation",
        permanent: true,
      },
      { source: "/analyse-dce-btp", destination: "/formation", permanent: true },
      { source: "/memoire-technique-btp", destination: "/formation", permanent: true },
      { source: "/doe-btp", destination: "/formation", permanent: true },
      { source: "/ppsps-btp", destination: "/formation", permanent: true },
      { source: "/compte-rendu-chantier", destination: "/formation", permanent: true },
      { source: "/situations-travaux-btp", destination: "/formation", permanent: true },
      { source: "/tutoriels", destination: "/formation", permanent: true },
      { source: "/guides", destination: "/formation", permanent: true },
      {
