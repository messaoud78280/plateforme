...
/** PATCH /api/me/coordonnees – Mettre à jour les coordonnées de l'entreprise */
export async function PATCH(request: NextRequest) {
  ...
  try {
    ...
    if (Object.prototype.hasOwnProperty.call(body, "company")) data.company = str(body.company);
