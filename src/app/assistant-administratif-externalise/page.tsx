...
export default function Page() {
  return (
    <SeoLandingPage
      description="L'assistant administratif externalisé BeWork prend en charge devis, factures, relances et suivi de dossiers pour les PME. Dès 590 € HT/mois. France, Belgique, Suisse, Luxembourg."
      breadcrumbItems={[
        { name: "Accueil", href: "/" },
      ...
      intro={
        <>
          ...
          entreprise dédié. France, Belgique, Suisse, Luxembourg — dès 590 € HT/mois.
        </>
      }
    >
      ...
      <p>
        ...
        BeWork propose des forfaits dès 590 € HT/mois, avec une équipe francophone supervisée depuis la France.
      </p>
