...
export default function Page() {
  return (
    <SeoLandingPage
      description="Assistant administratif pour PME : externaliser devis, factures, relances. Assistant virtuel entreprise dès 790 € HT/mois. France, Belgique, Suisse, Luxembourg."
      breadcrumbItems={[
        { name: "Accueil", href: "/" },
      ...
      intro={
        <>
          ...
          Assistant administratif externalisé dès 790 € HT/mois.
        </>
      }
    >
      ...
      <p>
        BeWork propose des forfaits dès 790 € HT/mois . Externaliser administratif PME coûte jusqu&apos;à
