...
export default function Page() {
  return (
    <SeoLandingPage
      description="Assistant administratif pour PME : externaliser devis, factures, relances. Assistant virtuel entreprise dès 290 € HT/mois. France, Belgique, Suisse, Luxembourg."
      breadcrumbItems={[
        { name: "Accueil", href: "/" },
      ...
      intro={
        <>
          ...
          Assistant administratif externalisé dès 290 € HT/mois.
        </>
      }
    >
      ...
      <p>
        BeWork propose des forfaits dès 290 € HT/mois (offre Structure). Externaliser administratif PME coûte jusqu&apos;à
