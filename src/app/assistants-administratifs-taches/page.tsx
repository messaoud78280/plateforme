...
export const metadata: Metadata = {
  ...
  alternates: { canonical: `${BASE_URL}/assistants-administratifs-taches` },
};
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#f8f9fb] via-[#eef0f4] to-[#e0e4ea]">
      ...
      <header className="sticky top-0 z-20 border-b border-[#c8cdd6] bg-[#f8f9fb]/95 backdrop-blur-sm">
        ...
        <nav className="mx-auto flex max-w-6xl flex-wrap items-center gap-x-5 gap-y-1 border-t border-[#e0e4ea] px-4 pt-3 pb-2 text-sm font-medium text-[#334155]">
          <Link href="/" className="whitespace-nowrap transition-colors hover:text-[#0f172a]">
            Accueil
          </Link>
          <Link href="/tarifs" className="whitespace-nowrap transition-colors hover:text-[#0f172a]">
            Tarifs
          </Link>
          <Link href="/contact" className="whitespace-nowrap transition-colors hover:text-[#0f172a]">
            Contact
          </Link>
        </nav>
      </header>
      ...
      <main>
        ...
        <section className="px-6 pt-16 pb-12 md:pt-20 md:pb-16" style={{ scrollMarginTop: "6rem" }}>
          <div className="mx-auto max-w-4xl text-center">
            <h1 className="text-balance text-3xl font-bold tracking-tight text-[#0f172a] md:text-4xl lg:text-5xl">
              Tâches d&apos;assistant administratif externalisé : ce que BeWork prend en charge
            </h1>
            <p className="mt-6 max-w-3xl mx-auto text-lg leading-relaxed text-[#334155]">
        ...
        <section className="px-6 py-12 md:py-16" aria-labelledby="top5-heading">
          <div className="mx-auto max-w-6xl">
            <h2 id="top5-heading" className="text-2xl font-bold tracking-tight text-[#0f172a] md:text-3xl">
              Les 5 tâches les plus chronophages (et les plus déléguées)
            </h2>
            <p className="mt-4 max-w-2xl text-[#334155] leading-relaxed">
            ...
            <ul className="mt-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              {top5Chronophages.map((item) => (
                <li key={item.title} className="card-frame rounded-lg p-6">
                  ...
                  <p className="mt-3 text-[#334155] leading-relaxed">{item.benefit}</p>
                </li>
              ))}
            </ul>
          </div>
        ...
        <section className="px-6 py-12 md:py-16" aria-labelledby="catalogue-heading">
          <div className="mx-auto max-w-6xl">
            <h2 id="catalogue-heading" className="text-2xl font-bold tracking-tight text-[#0f172a] md:text-3xl">
            ...
            <div className="mt-10 space-y-10">
              {catalogue.map((cat) => (
                <article key={cat.h2} className="card-frame rounded-xl p-6 md:p-8">
                  <h3 className="text-xl font-semibold text-[#0f172a]">{cat.h2}</h3>
                  <p className="mt-2 text-[#334155]">{cat.benefice}</p>
        ...
        <section className="px-6 py-12 md:py-16" aria-labelledby="non-fait-heading">
          <div className="mx-auto max-w-4xl">
            <h2 id="non-fait-heading" className="text-2xl font-bold tracking-tight text-[#0f172a] md:text-3xl">
        ...
        <section className="px-6 py-12 md:py-16" aria-labelledby="process-heading">
          <div className="mx-auto max-w-6xl">
            <h2 id="process-heading" className="text-2xl font-bold tracking-tight text-[#0f172a] md:text-3xl">
              Comment ça marche
            </h2>
        ...
        <section className="px-6 py-12 md:py-16" aria-labelledby="faq-heading">
          <div className="mx-auto max-w-3xl">
            <h2 id="faq-heading" className="text-2xl font-bold tracking-tight text-[#0f172a] md:text-3xl">
              ...
              {faqItems.map((item, i) => (
                <li key={i} className="rounded-xl border border-[#e0e4ea] bg-white shadow-sm">
                  <details className="group">
                    ...
                    <div className="border-t border-[#e0e4ea] px-4 py-3 text-[#334155]">{item.a}</div>
                  </details>
                </li>
              ))}
            </ul>
      ...
      <footer className="border-t border-[#c8cdd6] bg-[#f8f9fb] px-6 py-8">
        <div className="mx-auto flex max-w-6xl flex-wrap items-center justify-between gap-4 text-sm text-[#334155]">
          <Link href="/" className="font-medium transition-colors hover:text-[#0f172a]">
            Accueil
          </Link>
          <Link href="/tarifs" className="font-medium transition-colors hover:text-[#0f172a]">
            Tarifs
          </Link>
          <Link href="/contact" className="font-medium transition-colors hover:text-[#0f172a]">
            Contact
          </Link>
        </div>
      </footer>
