    ...
    <div className="min-h-screen bg-gradient-to-b from-[#f8f9fb] via-[#eef0f4] to-[#e0e4ea]">
      ...
      <main className="mx-auto max-w-6xl px-6 py-16 md:py-24">
          ...
          {cases.map((c) => (
            <article key={c.title} className="rounded-2xl surface-metallic-light p-7">
              ...
              <div className="mt-4 space-y-3 text-sm text-[#334155]">
                <p>
                  <span className="font-semibold text-[#64748b]">Avant :</span> {c.before}
                </p>
                <p>
                  <span className="font-semibold text-[#64748b]">Après :</span> {c.after}
                </p>
              </div>
              <ul className="mt-5 space-y-2 text-sm text-[#334155]" role="list">
                {c.kpis.map((k) => (
        ...
        <section className="mx-auto mt-10 max-w-5xl rounded-2xl border border-[#dce3ec] bg-white/60 p-7">
          <h2 className="text-lg font-semibold text-[#0f172a]">Tu veux que je mette tes vrais chiffres ?</h2>
