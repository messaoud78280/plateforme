...
/** Canonical demandé (www) — peut différer de SITE_URL hors prod. */
const CANONICAL_URL = "https://www.bework.fr/ressources/compte-rendu-chantier-guide-btp";
        ...
        <main className="mx-auto flex w-full max-w-6xl flex-col px-6 pb-20 pt-[calc(4.55rem+0.375rem)] sm:pb-28 sm:pt-[calc(4.55rem+0.5rem)] md:pt-[calc(4.55rem+0.625rem)]">
          ...
          <header className="mb-12 w-full">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-center sm:gap-4">
              ...
              <span className="text-sm leading-snug text-slate-600 sm:max-w-sm">
                20&nbsp;minutes pour cadrer votre besoin (CR chantier, relais administratif BTP) — sans engagement.
              </span>
            </div>
          </header>
          ...
          >
            <div className="min-w-0 sm:flex-1">
              <p className="text-base font-semibold text-slate-900 md:text-[1.05rem]">Besoin d’un relais sur vos CR de chantier&nbsp;?</p>
