...
const pagePath = "/ressources/guide-chef-de-chantier-bework";
const pageUrl = absoluteUrl(pagePath);
const pdfPath = "/ressources/pdf/guide-chef-de-chantier-bework.pdf";

export const metadata = tutoPageMetadata(pagePath);

const H1 = "Le Guide du Chef de Chantier — 6 outils Claude pour ton chantier au quotidien";

const breadcrumbItems = [
  { name: "Accueil", href: "/" },
  { name: "Ressources", href: "/ressources" },
  { name: "Guides", href: "/ressources/guides" },
  { name: "Guide Chef de Chantier", href: pagePath },
] as const;

const OUTILS = [
  "01 · Accueil sécurité au poste — IA, 5 min au lieu de 30 min",
  "02 · Mode opératoire / fiche de tâche — Mixte, 10 min au lieu d’1 h",
  "03 · Quart d’heure sécurité — IA, 5 min au lieu de 30 min",
  "04 · Rapport journalier de chantier — IA, 5 min au lieu de 30 min",
  "05 · Demande d’approvisionnement — IA, 3 min au lieu de 20 min",
  "06 · Auto-contrôle & levée de réserves terrain — Mixte, 15 min au lieu d’1 h",
] as const;

export default function GuideChefDeChantierBeWorkPage() {
      ...
      <main className="mx-auto max-w-site px-4 pb-16 pt-10 sm:px-6 md:pb-20 md:pt-12">
        ...
        <header className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm md:p-8">
          <p className="text-xs font-semibold uppercase tracking-[0.18em] text-[#1d4ed8]">
            Guide PDF · 17 pages · Chef de chantier · Mode mobile
          </p>
          ...
          <div className="mt-6 flex flex-wrap items-center gap-3">
            <a
              href={pdfPath}
              download="BeWork-Guide-Chef-de-Chantier.pdf"
        ...
        <section className="mt-10 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm md:p-8" aria-labelledby="sommaire-heading">
          <h2 id="sommaire-heading" className="text-xl font-semibold tracking-tight text-slate-900">
            6 outils Claude — du démarrage au repli de chantier
          </h2>
          <p className="mt-3 max-w-3xl leading-relaxed text-slate-600">
            Pensé pour l’app Claude sur ton téléphone : tu dictes ta journée ou tu prends la photo d’un constat, Claude
            met en forme aux normes. Les skills se créent une fois sur ordinateur, puis se pilotent au quotidien depuis
            le chantier. Chaque outil donne le prompt exact à copier-coller et le gain de temps mesuré.
          </p>
        ...
        <section className="mt-10 rounded-3xl border border-slate-200 bg-slate-100/80 p-6 shadow-sm sm:p-10" aria-label="Aperçu PDF">
          ...
          <div className="mx-auto mt-8 w-full max-w-none">
            <iframe
              ...
              title="Le Guide du Chef de Chantier — PDF BeWork"
            />
          </div>
        </section>
      </main>
