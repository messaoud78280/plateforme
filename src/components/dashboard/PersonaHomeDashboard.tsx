...
function quickLinks(
  ...
  if (personType === "SUPPLIER") {
    return [
      { href: "/dashboard/commandes", label: "Commandes", hint: "Suivre les commandes chantier" },
      { href: "/dashboard/messagerie", label: "Communication", hint: "Fil fournisseur uniquement" },
      { href: "/dashboard/documents", label: "Documents", hint: "BL, fiches, partagés" },
      { href: "/dashboard/projets", label: "Chantiers", hint: "Périmètre partagé avec vous" },
    ];
  }
    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="mt-2 max-w-2xl text-sm text-slate-600">
          Accès limité aux chantiers partagés avec vous. La messagerie utilise le fil{" "}
          <strong>{MESSAGE_CHANNEL_LABELS[channel]}</strong> — les échanges internes de
          l&apos;entreprise ne vous sont pas visibles.
        </p>
      </div>
