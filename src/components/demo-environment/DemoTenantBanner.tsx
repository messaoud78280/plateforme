...
import { demoBrandBannerCompanyLabel } from "@/lib/demo-environment/brand";
...
export function DemoTenantBanner({
  ...
  const brandLabel = demoBrandBannerCompanyLabel(companyName);
  ...
  return (
    ...
    >
      ENVIRONNEMENT DE DÉMONSTRATION — {brandLabel} · données fictives
