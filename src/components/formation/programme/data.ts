...
export const DAY_TWO_STEPS: readonly ProgramStep[] = [
  ...
  },
  {
    ...
    subtitle:
      "Découvrir les fondamentaux SEO utiles à un vrai projet. Le SEO ne consiste pas simplement à ajouter des mots-clés.",
    actions: [
    ...
    result: "Votre site est mieux structuré pour être compris par les moteurs de recherche.",
  },
  {
    id: "seo-technique",
    time: "15:00",
...
export const PROGRAM_DAYS: readonly ProgramDay[] = [
  ...
  },
  {
    ...
    description:
      "Le Jour 2 reprend directement le projet construit pendant le Jour 1. Nous allons plus loin : architecture, fonctionnalités, robustesse, mise en ligne, SEO, indexation, suivi et audit final.",
    steps: DAY_TWO_STEPS,
    outcomes: [
      "repris un projet existant",
      "amélioré son architecture",
      "développé de nouvelles fonctionnalités",
      "contrôlé sa robustesse",
      "préparé la production",
      "mis le projet en ligne",
      "préparé son référencement",
      "vérifié son SEO technique",
      "connecté les outils de suivi",
      "réalisé un audit complet",
      "organisé les prochaines évolutions",
    ],
    closingLine:
      "Vous ne repartez pas avec un exercice. Vous repartez avec votre projet et une méthode pour continuer à le faire évoluer.",
    summaryLabel: "Jour 2 — Finaliser · Publier · Référencer · Contrôler",
    summaryFlow: [
      "Première version",
      "Amélioration",
      "Renforcement",
