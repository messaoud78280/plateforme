...
export function HomeHeroPlanSketchDecor() {
  return (
    <div className="absolute inset-0 overflow-hidden" aria-hidden>
      ...
      <svg
        className="absolute left-1/2 top-0 h-[min(92vh,920px)] w-[min(145%,1480px)] -translate-x-1/2 text-[#2563eb] opacity-[0.42] motion-reduce:opacity-[0.28] sm:opacity-[0.48] md:h-full md:min-h-[640px] md:opacity-[0.52]"
