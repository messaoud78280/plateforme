...
export function MarketingHeaderBlueprintDecor({ plainBg = false }: Props) {
  const coarse = plainBg ? "opacity-[0.26] md:opacity-[0.3]" : "opacity-[0.32] md:opacity-[0.38]";
  const fine = plainBg ? "opacity-[0.2] md:opacity-[0.24]" : "opacity-[0.26] md:opacity-[0.32]";
  const svgLayer = plainBg ? "opacity-[0.42] md:opacity-[0.52]" : "opacity-[0.52] md:opacity-[0.62]";
