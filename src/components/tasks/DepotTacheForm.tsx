  ...
  return (
    <div className="rounded-2xl surface-metallic-light p-6">
      ...
      <p className="mt-1 text-sm text-slate-500">
        Décrivez votre demande et joignez vos documents. L&apos;agence évalue le nombre de crédits après réception.
      </p>
      <form onSubmit={handleSubmit} className="mt-4 space-y-4">
        ...
        <div>
          <label htmlFor="depot-description" className="mb-1 block text-sm font-medium text-slate-700">
            Description et recommandations (optionnel)
          </label>
          <textarea
            ...
            disabled={loading}
            rows={3}
            placeholder="Précisez le contexte, vos recommandations, les délais ou les instructions."
            className="w-full rounded-lg border border-slate-300 px-3 py-2 text-slate-800 placeholder:text-slate-400 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 disabled:bg-slate-100"
          />
        </div>
