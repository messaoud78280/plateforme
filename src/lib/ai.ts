...
export async function analyzeMissionFromText(text: string): Promise<MissionSuggestion> {
  ...
  let estimatedActions: MissionSuggestion["estimatedActions"] = "1 action";
  ...
  if (contains("devis")) {
    ...
    estimatedActions = contains("plusieurs", "série", "plusieurs devis") ? "2 à 3 actions" : "1 action";
    ...
    estimatedActions = contains("plusieurs", "liste") ? "2 à 3 actions" : "1 action";
    ...
    category = "Documents";
    estimatedActions = contains("beaucoup", "grand nombre", "dossier complet") ? "2 à 3 actions" : "1 action";
