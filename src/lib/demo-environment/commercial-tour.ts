...
export const EXPRESS_TOUR_STEPS: DemoTourStepDef[] = [
  ...
  },
  {
    ...
    body: "Point.P ne voit que ses commandes, livraisons, documents et échanges autorisés.",
...
export const COMPLETE_TOUR_STEPS: DemoTourStepDef[] = [
  ...
  {
    id: "complete-julie",
    title: "Julie — Administratif",
    body: "Le bureau voit documents, BL et actions administratives sur le même fil.",
    tip: "Passer si les données Julie ne sont pas parlantes.",
    persona: "administratif",
    href: "/dashboard/documents",
    actionLabel: "Documents Julie",
    optional: true,
  },
  {
    id: "complete-sophie",
