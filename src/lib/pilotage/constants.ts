...
export const DETAIL_PRIMARY_TABS = [
  ...
  { id: "securisation", label: "Sécurisation", icon: "shield" },
...
export const DETAIL_MORE_TABS = [
  { id: "echeances", label: "Échéances sensibles" },
  { id: "hypotheses", label: "Hypothèses de chiffrage" },
  { id: "retards", label: "Retards" },
  { id: "nc", label: "Non-conformités" },
  { id: "chronologie", label: "Chronologie des faits" },
  { id: "qualite", label: "Qualité des données" },
  { id: "passation", label: "Passation études → travaux" },
  { id: "interfaces", label: "Interfaces entre lots" },
  { id: "reservations", label: "Réservations / incorporations" },
  { id: "ouvrages", label: "Ouvrages sensibles" },
  { id: "reunions", label: "Réunions" },
  { id: "photos", label: "Photos documentées" },
  { id: "rex", label: "Retour d’expérience" },
...
export const DETAIL_TABS = [
  ...
  { id: "securisation", label: "Sécurisation" },
...
export const SECURISATION_HUB_LINKS = [
  { id: "echeances", label: "Échéances sensibles", hint: "Délais à vérifier et à traiter" },
  { id: "retards", label: "Retards", hint: "Événements perturbateurs (origine enregistrée)" },
  { id: "nc", label: "Non-conformités", hint: "Constats et actions correctives" },
  { id: "chronologie", label: "Chronologie", hint: "Faits datés et preuves" },
  { id: "qualite", label: "Qualité des données", hint: "Éléments incomplets ou incohérents" },
] as const;

export const METHODE_HUB_LINKS = [
  { id: "passation", label: "Passation", hint: "Études → travaux" },
  { id: "hypotheses", label: "Hypothèses", hint: "Chiffrage vs réalité chantier" },
  { id: "interfaces", label: "Interfaces lots", hint: "Qui fournit / qui pose" },
  { id: "reservations", label: "Réservations", hint: "Avant coulage / fermeture" },
  { id: "ouvrages", label: "Ouvrages sensibles", hint: "Contrôles et preuves enregistrées" },
  { id: "reunions", label: "Réunions", hint: "Préparation et décisions" },
  { id: "photos", label: "Photos", hint: "Preuves visuelles documentées" },
  { id: "rex", label: "REX", hint: "Capitalisation (validation requise)" },
  { id: "formation", label: "Formation", hint: "Notions métier contextuelles" },
] as const;
