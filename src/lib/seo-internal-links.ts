...
export const SEO_INTERNAL_LINKS: Record<string, SeoInternalLink[]> = {
  "/": [
    ...
    { href: "/demonstrations/agenda", label: "Démo agenda" },
    { href: "/demonstrations/reservation", label: "Démo réservation" },
    { href: "/demonstrations/crm", label: "Démo CRM" },
    { href: "/demonstrations/dashboard", label: "Démo tableau de bord" },
  ],
  "/tarifs": [
  ...
  "/formation": [
    ...
    { href: "/faq", label: "FAQ" },
    { href: "/contact#participer", label: "Participer" },
  ],
  "/demonstrations": [
    { href: "/formation", label: "La formation" },
    { href: "/demonstrations/messagerie", label: "Messagerie" },
    { href: "/demonstrations/agenda", label: "Agenda" },
    { href: "/demonstrations/crm", label: "CRM" },
    { href: "/contact#participer", label: "Participer" },
  ],
  "/pour-qui": [
    { href: "/formation", label: "La formation" },
  ...
  "/externaliser-administratif": [
    ...
    { href: "/assistants-administratifs-taches", label: "Capacités plateforme" },
  ...
  "/assistant-administratif-externalise": [
    { href: "/externaliser-administratif", label: "Structurer l'admin chantier" },
    { href: "/assistants-administratifs-taches", label: "Capacités plateforme" },
    { href: "/services/assistant-travaux", label: "Assistant travaux IA" },
    { href: "/tarifs", label: "Tarification" },
  ],
  "/assistant-administratif-pme": [
    { href: "/assistant-administratif-externalise", label: "Plateforme sans recruter" },
    { href: "/assistants-administratifs-taches", label: "Capacités BTP" },
  ...
  "/avenant-chantier": [
    ...
    { href: "/gestion-marche-public-btp", label: "Gestion marché public" },
    { href: "/assistants-administratifs-taches", label: "Capacités assistant travaux" },
    { href: "/tarifs", label: "Tarification" },
  ],
  "/suivi-fournisseurs-chantier": [
    { href: "/assistants-administratifs-taches", label: "Capacités logistique & fournisseurs" },
  ...
  "/comparatif-assistance-travaux-btp": [
    { href: "/tarifs", label: "Tarification BeWork" },
